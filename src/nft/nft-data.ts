export enum NFTTypes {
  ...
  MARMALADE_NG = 'MARMALADE_NG',
}

export const MARMALADE_NG_CHAINS = ['8', '1'];
export const MARMALADE_NG_CONTRACT =
...
const brawlerBearsPic = require('../assets/images/nft/brawler-bears.png');
const arkade80sBullsPic = require('../assets/images/nft/arkade-80s-bulls.png');
const kadenaMiningClubPic = require('../assets/images/nft/kadena-mining-club.webp');
...
const nftList: NFTData[] = [
  {
    ...
    getPicById: () => '#',
    getDetailLinkById: auctionId =>
      `https://nft.immutablerecord.com/?auctionId=${auctionId}`,
  ...
  },
  {
    ...
    pic: brawlerBearsPic,
    getPicById: id =>
      `https://arkade-prod.s3.amazonaws.com/brawler-bears/${id}.png`,
    getDetailLinkById: id =>
      `https://www.arkade.fun/marketplace/brawler-bears/${id}`,
    getAccountBalance: account =>
      `(free.brawler-bears.ids-owned-by "${account}")`,
  ...
  },
  {
    ...
    getPicById: id =>
      `https://arkade-prod.s3.amazonaws.com/looney-bulls/${id}.png`,
    getDetailLinkById: id =>
      `https://www.arkade.fun/marketplace/looney-bulls/${id}`,
    getAccountBalance: account =>
      `(free.looney-bulls-airdrop.ids-owned-by "${account}")`,
    type: NFTTypes.ARKADE,
  },
  {
    chainId: 1,
    ...
    getDetailLinkById: id =>
      `https://www.arkade.fun/marketplace/sphynxxx-cats/${id}`,
    getAccountBalance: account =>
      `(free.sphynxxx-cats.ids-owned-by "${account}")`,
    type: NFTTypes.ARKADE,
  },
  {
    chainId: 1,
    ...
    pic: arkade80sBullsPic,
    getPicById: id =>
      `https://arkade-prod.s3.amazonaws.com/arkade-80s-bulls/${id}.png`,
    getDetailLinkById: id =>
      `https://www.arkade.fun/marketplace/eighties-bulls/${id}`,
    getAccountBalance: account =>
      `(free.eighties-bulls.ids-owned-by "${account}")`,
    type: NFTTypes.ARKADE,
  },
  {
    chainId: 1,
    ...
    getPicById: id =>
      `https://arkade-prod.s3.amazonaws.com/arkade-90s-bulls/${id}.png`,
    getDetailLinkById: id =>
      `https://www.arkade.fun/marketplace/90s-bulls/${id}`,
    getAccountBalance: account =>
      `(free.nineties-bulls.ids-owned-by "${account}")`,
    type: NFTTypes.ARKADE,
  },
  {
    chainId: 1,
    ...
    getPicById: id =>
      `https://storage.googleapis.com/lazypenguins/${id}.png`,
    getDetailLinkById: id =>
      `https://www.arkade.fun/marketplace/lazy-penguins/${id}`,
    getAccountBalance: account =>
      `(free.lazy-penguins.ids-owned-by "${account}")`,
    type: NFTTypes.ARKADE,
  },
  {
    chainId: 1,
    ...
    getPicById: id =>
      `https://storage.googleapis.com/kadenaskellies/${id}.png`,
    getDetailLinkById: id =>
      `https://www.arkade.fun/marketplace/kadena-skellies/${id}`,
    getAccountBalance: account =>
      `(free.kda-skellies.ids-owned-by "${account}")`,
    type: NFTTypes.ARKADE,
  },
  {
    chainId: 1,
    ...
    getPicById: id =>
      `https://arkade-prod.s3.amazonaws.com/variation-apes/${id}.png`,
    getDetailLinkById: id =>
      `https://www.arkade.fun/marketplace/variation-apes/${id}`,
    getAccountBalance: account =>
      `(free.variation-apes.ids-owned-by "${account}")`,
    type: NFTTypes.ARKADE,
  },
  {
    chainId: 1,
    ...
    getDetailLinkById: id =>
      `https://www.arkade.fun/marketplace/pact-rats/${id}`,
    getAccountBalance: account =>
      `(free.pact-rats.ids-owned-by "${account}")`,
    type: NFTTypes.ARKADE,
  },
  {
    chainId: 1,
    ...
    getDetailLinkById: id =>
      `https://www.arkade.fun/marketplace/secret-garden-of-kadena/${id}`,
    getPicById: id =>
      `https://arkade-prod.s3.us-east-1.amazonaws.com/secret-garden-of-kadena/${id}.png`,
    getAccountBalance: account =>
      `(free.secret-garden-of-kadena.ids-owned-by "${account}")`,
    type: NFTTypes.ARKADE,
  },
  {
    chainId: 1,
    ...
    getPicById: id =>
      `https://arkade-prod.s3.us-east-1.amazonaws.com/punks/${id}.png`,
    getDetailLinkById: id =>
      `https://www.arkade.fun/marketplace/kda-punks/${id}`,
  ...
  },
  {
    ...
    getAccountBalance: account =>
      `(free.gen-1-kitty-kad-kitties.ids-owned-by "${account}")`,
  ...
  },
  {
    ...
    getAccountBalance: account =>
      `(free.kitty-kad-kitties.ids-owned-by "${account}")`,
    type: NFTTypes.KITTY_KAD,
  },
  {
    chainId: 8,
    ...
    pic: kadenaMiningClubPic,
    getPicById: id => `https://farm.kdamining.club/assets/${id}.jpeg`,
    getDetailLinkById: id =>
      `https://farm.kdamining.club/view?id=${id}&type=miner`,
    getAccountBalance: account =>
      `(free.kadena-mining-club.get-user-miners "${account}")`,
  ...
  },
  {
    ...
    getPicById: id => `https://farm.kdamining.club/assets/${id}.jpeg`,
    getDetailLinkById: id =>
      `https://farm.kdamining.club/view?id=${id}&type=founders`,
    getAccountBalance: account =>
      `(free.kadena-mining-club.get-user-founders "${account}")`,
  ...
  },
  {
    ...
    getPicById: id =>
      `https://storage.googleapis.com/wizarena/generated_imgs/${id}.png`,
    getDetailLinkById: id => `https://www.wizardsarena.net/nft/${id}`,
    getAccountBalance: account =>
      `(free.wiz-arena.wizard-owned-by "${account}")`,
...
function getImmutableRecordsAccountList(numAuctions: number, account: string) {
  let pactCode = '(let* (';
...
export const getGatewayUrlByIPFS = (ipfsUrl: string, chainId: string | number) => {
...
export function extractProtocolAndCID(url: string) {
  const [protocol, rest] = url.split('://');
  const cid = rest?.split('/').pop() || '';
  return {protocol, cid};
}

export function getCollectionsAndTokens(numCollections: number) {
  let pactCode = '(let* (';
